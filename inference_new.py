...
def main():
	...
	# encoding input
	data = []
	data.append(data_functions.encoding(word, alphabet_and_morph_tags))
	data.append(data_functions.encoding(tags, alphabet_and_morph_tags))
	...
	with tf.Session() as sess:
		...
		print('predicted:',data_functions.convert_back_tostring(parameters, predict_.T, alphabet_and_morph_tags))
